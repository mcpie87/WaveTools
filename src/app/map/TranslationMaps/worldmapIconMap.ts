...
const GameAssetIcons: Record<string, IconUrl | IconRecord> = {
  ...
  "Soliskin Collect": "Atlas/WorldMapIcon/SP_IconMap_Play_57_UI.png",
  ...
  [Echo3Cost.TWIN_NOVA_COLLAPSAR_BLADE]: "Image/IconMonsterHead/T_IconMonsterHead_32050_UI.png",
...
const CustomIcons: Record<string, IconUrl> = {
  ...
  "Basic Trophy Chest": "Basic_Supply_Chest.webp",
  "Standard Trophy Chest": "Standard_Supply_Chest.webp",
  "Advanced Trophy Chest": "Advanced_Supply_Chest.webp",
  "Premium Trophy Chest": "Premium_Supply_Chest.webp",
