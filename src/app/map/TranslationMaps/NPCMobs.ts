...
export const NPCMobsTranslationMap: Record<string, TranslationMapEntry> = {
  ...
  "Monster020": { name: "Exile Commoner" },
  "Monster022": { name: "Exile Commoner" },
  "Monster027": { name: "Exile Commoner" },
  "Monster029": { name: "Exile Commoner" },
  "Monster055": { name: "Exile Leader" },
  "Monster056": { name: "Exile Technician" },
