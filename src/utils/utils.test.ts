...
const ASSET_URL = "https://raw.githubusercontent.com/alt3ri/WW_Asset_Webp/refs/heads/main/";
...
describe('utils test', () => {
  test('icon url should return correct url', () => {
    ...
    expect(convertToUrl(urls[0])).toBe(ASSET_URL + "UIResources/Common/Image/IconWup160/T_IconWup160_02_UI.webp");
    expect(convertToUrl(urls[1])).toBe(ASSET_URL + "UIResources/Common/Atlas/SkillIcon/SkillIconNor/SP_IconNorKnife.webp");
    expect(convertToUrl(urls[2])).toBe(ASSET_URL + "UIResources/Common/Image/IconWeapon160/T_IconWeapon160_21030015_UI.webp");
    expect(convertToUrl(urls[3])).toBe(ASSET_URL + "UIResources/Common/Image/IconRoleHeadCircle256/T_IconRoleHeadCircle256_8_UI.webp");
    expect(convertToUrl(urls[4])).toBe(ASSET_URL + "UIResources/Common/Image/IconRoleHead256/T_IconRoleHead256_7.webp");
  });
